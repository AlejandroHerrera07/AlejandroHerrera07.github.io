...
L.tileLayer('https://tiles.stadiamaps.com/tiles/alidade_smooth_dark/{z}/{x}/{y}{r}.png?api_key=0f173ca6-6c5d-437b-9955-46c6d4cef7de', {
...
document.getElementById('select-location').addEventListener('change', function (option) {
    ...
    // L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png?api_key=0f173ca6-6c5d-437b-9955-46c6d4cef7de', {
